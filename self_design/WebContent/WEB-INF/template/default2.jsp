...
<c:if test="${pageInfo.totalPage > 0}">
    <a href="${pageInfo.url}${pageInfo.separator}${pageInfo.pageParam}=1${pageInfo.paramString}" class="prev"><img src="${imageServer}/images/admin/btn_page_prev.gif" alt="처음" /></a>
