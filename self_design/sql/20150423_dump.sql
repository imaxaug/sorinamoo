...
INSERT INTO `color_size` (`color`, `size`, `price`, `extra_price`, `use_yn`) VALUES
...
-- 테이블 데이터 aromabloom.common_code:~106 rows (대략적) 내보내기
DELETE FROM `common_code`;
/*!40000 ALTER TABLE `common_code` DISABLE KEYS */;
INSERT INTO `common_code` (`code_class`, `code_key`, `code_value`, `code_order`, `code_desc`, `code_use_yn`, `create_date`, `last_update`, `code_class_id`) VALUES
...
INSERT INTO `design` (`design_id`, `design_name`, `file_path`, `price`, `premium_yn`, `description`, `seller_id`, `use_yn`, `create_date`, `last_update`, `best`, `category`, `width`, `height`) VALUES
	...
	(2, '복싱선수', '/up/design/3169483538_6_thumbnail.png', '2000', 'Y', '복싱선수', NULL, 'Y', '2015-04-23 12:24:31', '2015-04-23 14:28:07', 0, 'IT002', NULL, NULL),
...
INSERT INTO `product` (`product_id`, `product_name`, `hit_count`, `like_count`, `use_yn`, `display_yn`, `create_date`, `last_update`, `hot`, `best`, `desc_title`, `description`, `color`, `size`, `price`, `extra_price`, `type`, `file_path`, `catalog`, `category`, `size_file_path`, `size_file_name`) VALUES
	(1, 'Value 반팔 [20수]', 2, NULL, 'Y', 'Y', NULL, '2015-04-24 09:26:33', '1', '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '/up/base_product/1/ValueS_Yellow_F.png', 'CAT001', 'TP001', NULL, NULL),
