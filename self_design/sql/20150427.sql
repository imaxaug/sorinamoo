...
REPLACE INTO `color_size` (`color`, `size`, `price`, `extra_price`, `use_yn`) VALUES
...
REPLACE INTO `common_code` (`code_class`, `code_key`, `code_value`, `code_order`, `code_desc`, `code_use_yn`, `create_date`, `last_update`, `code_class_id`) VALUES
	...
	('TYPE', 'FT001', '앞면', 1, NULL, 'Y', '2015-04-27 18:14:00', '2015-04-27 18:14:00', 107),
	('TYPE', 'FT002', '뒷면', 2, NULL, 'Y', '2015-04-27 18:14:00', '2015-04-27 18:14:00', 108),
	('TYPE', 'FT008', '티셔츠 목뒤', 3, NULL, 'Y', '2015-04-27 18:14:00', '2015-04-27 18:14:00', 109),
	('TYPE', 'FT005', '왼쪽 사진', 4, NULL, 'Y', '2015-04-27 18:14:00', '2015-04-27 18:14:00', 110),
	('TYPE', 'FT006', '오른쪽 사진', 5, NULL, 'Y', '2015-04-27 18:14:01', '2015-04-27 18:14:01', 111);
...
REPLACE INTO `design` (`design_id`, `design_name`, `file_path`, `price`, `premium_yn`, `description`, `seller_id`, `use_yn`, `create_date`, `last_update`, `best`, `category`, `width`, `height`) VALUES
...
-- 테이블 데이터 aromabloom.login_history:~0 rows (대략적) 내보내기
...
-- 테이블 데이터 aromabloom.message:~0 rows (대략적) 내보내기
...
REPLACE INTO `product` (`product_id`, `product_name`, `hit_count`, `like_count`, `use_yn`, `display_yn`, `create_date`, `last_update`, `hot`, `best`, `desc_title`, `description`, `color`, `size`, `price`, `extra_price`, `type`, `file_path`, `catalog`, `category`, `size_file_path`, `size_file_name`) VALUES
...
REPLACE INTO `product_color` (`product_id`, `color`) VALUES
	(21, '000000'),
	(21, '022954'),
	(21, '304dc2'),
	(21, '8bdfff'),
...
REPLACE INTO `product_size` (`product_id`, `size`) VALUES
	(21, 'SZ007'),
	(21, 'SZ008'),
	(21, 'SZ009'),
	(21, 'SZ010'),
...
REPLACE INTO `product_type` (`product_id`, `type`, `type_order`, `loc_top`, `loc_left`, `loc_width`, `loc_height`, `price`, `only_vector`, `file_path`, `file_name`) VALUES
	(21, 'FT001', 1, 115, 162, 340, 220, 6000, 'N', '/up/base_product/21/CM_White_F.png', 'CM_White_F.png'),
	(21, 'FT002', 2, 110, 160, 340, 220, 6000, 'N', '/up/base_product/21/CM_White_B.png', 'CM_White_B.png'),
	(21, 'FT005', 3, 110, 115, 180, 290, 3000, 'Y', '/up/base_product/21/CM_White_N.png', 'CM_White_N.png'),
	(21, 'FT006', 4, 160, 240, 330, 100, 3000, 'Y', '/up/base_product/21/CM_White_L.png', 'CM_White_L.png'),
	(21, 'FT008', 5, 160, 210, 330, 100, 3000, 'Y', '/up/base_product/21/CM_White_R.png', 'CM_White_R.png');
...
REPLACE INTO `type_size` (`product_type`, `product_size`, `loc_top`, `loc_left`, `loc_width`, `loc_height`, `product_id`, `use_yn`) VALUES
	('FT001', 'SZ007', 3, 5, 34, 38, 21, 'Y'),
	('FT001', 'SZ007', 3, 5, 34, 38, 21, 'Y'),
	('FT001', 'SZ008', 3, 5, 34, 38, 21, 'Y'),
	('FT001', 'SZ009', 3, 5, 36, 40, 21, 'Y'),
	('FT001', 'SZ010', 3, 5, 36, 40, 21, 'Y'),
	('FT001', 'SZ011', 3, 5, 38, 42, 21, 'Y'),
	('FT001', 'SZ012', 3, 5, 38, 42, 21, 'Y'),
	('FT002', 'SZ007', 7, 5, 34, 38, 21, 'Y'),
	('FT002', 'SZ008', 7, 5, 34, 38, 21, 'Y'),
	('FT002', 'SZ009', 7, 5, 36, 40, 21, 'Y'),
	('FT002', 'SZ010', 7, 5, 36, 40, 21, 'Y'),
	('FT002', 'SZ011', 7, 5, 38, 42, 21, 'Y'),
	('FT002', 'SZ012', 7, 5, 38, 42, 21, 'Y'),
	('FT005', 'SZ007', 1, 1, 12, 42, 21, 'Y'),
	('FT005', 'SZ008', 1, 1, 12, 42, 21, 'Y'),
	('FT005', 'SZ009', 1, 1, 12, 44, 21, 'Y'),
	('FT005', 'SZ010', 1, 1, 12, 46, 21, 'Y'),
	('FT005', 'SZ011', 1, 1, 12, 46, 21, 'Y'),
	('FT005', 'SZ012', 1, 1, 12, 48, 21, 'Y'),
	('FT006', 'SZ007', 1, 1, 12, 42, 21, 'Y'),
	('FT006', 'SZ008', 1, 1, 12, 42, 21, 'Y'),
	('FT006', 'SZ009', 1, 1, 12, 44, 21, 'Y'),
	('FT006', 'SZ010', 1, 1, 12, 46, 21, 'Y'),
	('FT006', 'SZ011', 1, 1, 12, 46, 21, 'Y'),
	('FT006', 'SZ012', 1, 1, 12, 48, 21, 'Y'),
	('FT008', 'SZ007', 1, 1, 12, 7, 21, 'Y'),
	('FT008', 'SZ008', 1, 1, 12, 7, 21, 'Y'),
	('FT008', 'SZ009', 1, 1, 12, 7, 21, 'Y'),
	('FT008', 'SZ010', 1, 1, 12, 7, 21, 'Y'),
	('FT008', 'SZ011', 1, 1, 12, 7, 21, 'Y'),
	('FT008', 'SZ012', 1, 1, 12, 7, 21, 'Y');
...
-- 테이블 데이터 aromabloom.user:~0 rows (대략적) 내보내기
