...
-- 테이블 aromabloom.product_canvas 구조 내보내기
DROP TABLE IF EXISTS `product_canvas`;
...
-- 테이블 데이터 aromabloom.product_canvas:~5 rows (대략적) 내보내기
DELETE FROM `product_canvas`;
/*!40000 ALTER TABLE `product_canvas` DISABLE KEYS */;
INSERT INTO `product_canvas` (`product_id`, `type`, `file_type`, `loc_top`, `loc_left`, `loc_width`, `loc_height`, `price`, `only_vector`, `file_path`, `file_name`, `sort`, `create_date`, `last_update`) VALUES
	(21, 'MAIN', 'FT001', 115, 162, 220, 340, 6000, 'N', '/up/base_product/21/CM_White_F.png', 'CM_White_F.png', 1, '2015-04-28 15:10:30', '2015-05-01 03:20:23'),
	(21, 'MAIN', 'FT002', 110, 160, 220, 340, 6000, 'N', '/up/base_product/21/CM_White_B.png', 'CM_White_B.png', 2, '2015-04-28 15:10:30', '2015-05-01 03:20:50'),
	(21, 'MAIN', 'FT005', 110, 115, 290, 180, 3000, 'Y', '/up/base_product/21/CM_White_N.png', 'CM_White_N.png', 3, '2015-04-28 15:10:30', '2015-05-01 03:21:12'),
	(21, 'MAIN', 'FT006', 160, 240, 100, 330, 3000, 'Y', '/up/base_product/21/CM_White_L.png', 'CM_White_L.png', 4, '2015-04-28 15:10:30', '2015-05-01 03:21:29'),
	(21, 'MAIN', 'FT008', 160, 210, 100, 330, 3000, 'Y', '/up/base_product/21/CM_White_R.png', 'CM_White_R.png', 5, '2015-04-28 15:10:30', '2015-05-01 03:21:31');
/*!40000 ALTER TABLE `product_canvas` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `product_type` (
  ...
  `create_date` datetime DEFAULT CURRENT_TIMESTAMP,
  `last_update` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='editor 창의 그림 영역';
...
INSERT INTO `product_type` (`product_id`, `type`, `file_type`, `loc_top`, `loc_left`, `loc_width`, `loc_height`, `price`, `only_vector`, `file_path`, `file_name`, `sort`, `create_date`, `last_update`) VALUES
	(21, 'MAIN', 'FT001', 3, 5, 34, 38, 6000, 'Y', '/up/base_product/21/CM_White_F.png', 'CM_White_F.png', 1, '2015-04-28 15:10:30', '2015-05-01 02:10:29'),
	(21, 'MAIN', 'FT002', 7, 5, 34, 38, 6000, 'N', '/up/base_product/21/CM_White_B.png', 'CM_White_B.png', 2, '2015-04-28 15:10:30', '2015-04-29 10:37:30'),
	(21, 'MAIN', 'FT005', 1, 1, 12, 42, 3000, 'Y', '/up/base_product/21/CM_White_N.png', 'CM_White_N.png', 3, '2015-04-28 15:10:30', '2015-04-29 10:37:30'),
	(21, 'MAIN', 'FT006', 1, 1, 12, 42, 3000, 'Y', '/up/base_product/21/CM_White_L.png', 'CM_White_L.png', 4, '2015-04-28 15:10:30', '2015-04-29 10:37:30'),
	(21, 'MAIN', 'FT008', 1, 1, 12, 7, 3000, 'Y', '/up/base_product/21/CM_White_R.png', 'CM_White_R.png', 5, '2015-04-28 15:10:30', '2015-04-29 10:37:30');
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `last_update` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '수정일자',
  PRIMARY KEY (`user_id`),
...
-- 테이블 aromabloom.user_saved 구조 내보내기
DROP TABLE IF EXISTS `user_saved`;
CREATE TABLE IF NOT EXISTS `user_saved` (
  `user_id` varchar(50) NOT NULL,
  `user_saved_seq` int(10) unsigned NOT NULL,
  `saved_use_code` int(10) unsigned NOT NULL,
  `saved_amt` int(10) unsigned NOT NULL,
  `use_end_date` varchar(8) NOT NULL COMMENT '사용종료일자',
  `buy_order_num` varchar(20) DEFAULT NULL COMMENT '구매주문번호',
  `pymnt_order_num` varchar(20) DEFAULT NULL COMMENT '결제주문번호(적립금 사용한 주문번호)',
  `saved_reason` varchar(3000) DEFAULT NULL COMMENT '적립금사유',
  `create_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `last_update` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`user_id`,`user_saved_seq`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='사용자 적립금 적립, 사용';

-- 테이블 데이터 aromabloom.user_saved:~0 rows (대략적) 내보내기
