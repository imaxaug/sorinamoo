...
public class UAgentInfo extends ToString {
    ...
    public boolean isTierTablet = false; // Stores the result ofDetectTierTablet()
    ...
    public static final String engineSilk = "silk-accelerated"; // Amazon's accelerated Silk browser for KindleFire
    ...
    public static final String mobile = "mobile"; // Some mobile browsers put "mobile" in their useragent strings.
    ...
    public boolean detectBlackBerryTouch() {
        if (detectBlackBerry()
                && (userAgent.indexOf(deviceBBStorm) != -1 || userAgent.indexOf(deviceBBTorch) != -1 || userAgent.indexOf(deviceBBBoldTouch) != -1 || userAgent
    ...
    public boolean detectMobileQuick() {
        ...
        if ((userAgent.indexOf(engineObigo) != -1) || (userAgent.indexOf(engineNetfront) != -1) || (userAgent.indexOf(engineUpBrowser) != -1)
    ...
    public boolean detectTierIphone() {
        ...
        if (detectIphoneOrIpod() || detectAndroidPhone() || detectWindowsPhone() || detectBlackBerry10Phone()
                || (detectBlackBerryWebKit() && detectBlackBerryTouch()) || detectPalmWebOS() || detectBada() || detectTizen() || detectGamingHandheld()) {
            return true;
        }
        return false;
    }
