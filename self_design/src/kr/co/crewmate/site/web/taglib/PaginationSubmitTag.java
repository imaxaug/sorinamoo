...
/**
 * 클래스명: <code>PaginationSubmitTag</code>
 *
 * <pre>
 *  Ajax전용 페이지태그
 * </pre>
...
public class PaginationSubmitTag extends TagSupport {
    ...
    public int doEndTag() throws JspTagException {
        try {
            ...
            pageContext.getRequest().getRequestDispatcher("/WEB-INF/template/" + this.template + ".jsp").include(pageContext.getRequest(), wrapper);
